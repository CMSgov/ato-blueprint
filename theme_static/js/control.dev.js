  ...
  $("#control-status").change(function () {
    ...
    $.ajax({
      ...
      if ($(".usa-alert").length) {
        ...
        $("#focus-area-wrapper").prepend('<div class="usa-alert usa-alert--success margin-1 padding-right-4"><div class="usa-alert__body">' + response.message + ' <b>' + status + '</b></div></div>');
      }
      ...
      if ($(".usa-alert").length) {
        ...
        $("#focus-area-wrapper").prepend('<div class="usa-alert usa-alert--error margin-1 padding-right-4"><div class="usa-alert__body">' + textStatus + '</div></div>');
      }
    });
  });
});