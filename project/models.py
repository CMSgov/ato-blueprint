...
class Package(models.Model):
    title = models.CharField(max_length=100, help_text="Name of the project", unique=False, blank=True, null=True)
    acronym = models.CharField(max_length=20, help_text="Acronym for the name of the project", unique=False, blank=True, null=True)
    ...
    impact_level = models.CharField(choices=IMPACT_LEVEL_CHOICES, max_length=20, null=True, help_text='FISMA impact level of the project')
    LOCATION_CHOICES = [
        ('cms_aws', 'CMS AWS Commercial'),
        ('govcloud', 'CMS AWS GovCloud'),
        ('azure', 'Microsoft Azure'),
        ('other', 'Other')
    ]
    location = models.CharField(choices=LOCATION_CHOICES, max_length=100, null=True, help_text='Where the project is located')
