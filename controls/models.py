...
class Statement(auto_prefetch.Model):
    ...
    def change_log_add_entry(self, change):
        ...
        if not isinstance(change, dict):
            ...
            messages.add_message(request, messages.ERROR, f'Statement {self.id} wasn\'t updated because the proposed change was not properly formatted.')
            return False
...
class Element(auto_prefetch.Model, TagModelMixin):
    ...
    description = models.TextField(help_text="Description of the Element", unique=False, blank=False, null=False)
