...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            ...
            required=False,
            type=str,
            default="system_element",
            help="Component (AKA element) type to export",
        )
        parser.add_argument(
            "--orderby",
            metavar="orderby",
            ...
            type=str,
            default="id",
            help="Order results by id or name",
        )
    ...
    def handle(self, *args, **options):
        ...
        if orderby == "name":
            elements = Element.objects.filter(element_type=element_type).order_by(
                "name"
            )
        else:
