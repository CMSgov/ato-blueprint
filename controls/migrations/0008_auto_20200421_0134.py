    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                related_name="statement_describing",
                to="controls.Element",
            ),
        ),
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True, related_name="statement_referencing", to="controls.Element"
            ),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "fisma_id",
                    models.CharField(
                        help_text="The FISMA Id of the system", max_length=40
                    ),
                ),
                (
                    "root_element",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="OSCAL formatted Catolog ID (e.g., 'uuid-26a2a133-f395-432c-b2ad-77d23a23ca4e')",
                        max_length=80,
                        null=True,
                    ),
                ),
