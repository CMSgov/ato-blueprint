...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name="name",
            field=models.CharField(
                help_text="Name of the CommonControlProvider", max_length=150
            ),
        ),
        migrations.CreateModel(
            name="Statement",
            fields=[
                ...
                (
                    "sid_class",
                    models.CharField(
                        help_text="Statement identifier 'class' such as '800-53rev4' or other OSCAL catalog name Control ID ",
                        max_length=200,
                    ),
                ),
                (
                    "body",
                    models.TextField(
                        blank=True, help_text="The statement itself", null=True
                    ),
                ),
                (
                    "statement_type",
