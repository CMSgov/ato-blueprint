...
urlpatterns = [
    ...
    url(r'^(?P<system_id>.*)/catalogs/(?P<catalog_key>.*)/control/(?P<cl_id>.*)/statement/(?P<statement_id>.*)$', views.project_control_editor, name="control_editor_statement"),
    url(r'^(?P<system_id>.*)/catalogs/(?P<catalog_key>.*)/control/(?P<cl_id>.*)/$', views.project_control_editor, name="control_editor"),
    ...
    url('components/add_system_component', views.add_system_component, name="add_system_component"),
