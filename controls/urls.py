...
urlpatterns = [
    ...
    url(r'^(?P<system_id>.*)/controls/catalogs/(?P<catalog_key>.*)/control/(?P<control_id>.*)/statement/(?P<statement_id>.*)$', views.control_editor, name="control_editor_statement"),
    url(r'^(?P<system_id>.*)/controls/catalogs/(?P<catalog_key>.*)/control/(?P<control_id>.*)$', views.control_editor, name="control_editor"),
